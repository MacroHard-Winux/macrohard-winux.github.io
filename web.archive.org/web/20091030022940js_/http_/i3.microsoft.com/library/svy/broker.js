...
version: 4.5.3
*/
var _sr_config = "../../../../../20100708100616/http_/www.microsoft.com/en/us/broker-config.html";
var _sr_builder = "../../../../../20100708100623/http_/www.microsoft.com/en/us/builder.html";
var _sr_sql08_URL = false;
var SR_url = window.location.toString().toLowerCase();
var SR_url_stripped = SR_url.split("?");

if(SR_url_stripped[0].search('http://[/\\w\\.-]+/sqlserver/2008/en/us/') != -1){	
	_sr_config = "../../../../../20100708100630/http_/www.microsoft.com/en/us/broker-config_v2.html";
	_sr_builder = "../../../../../20100708100639/http_/www.microsoft.com/en/us/builder_v2.html";
	_sr_sql08_URL = true;
	...
	COMSCORE.SiteRecruit.Broker = ( function() {
		...
		return {
			init: function() {
				...
				_sr.executingPath = _utils.getExecutingPath("../../../../../20100708100836/http_/www.microsoft.com/en/us/broker.html");
				if(_sr.executingPath != "http://web.archive.org/web/20091030022940/http://js.microsoft.com/library/svy") { _sr.executingPath="http://web.archive.org/web/20091030022940/http://js.microsoft.com/library/svy/"; }
...
/*
     FILE ARCHIVED ON 02:29:40 Oct 30, 2009 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 164.282
  exclusion.robots: 0.133
  exclusion.robots.policy: 0.119
  cdx.remote: 0.079
  esindex: 0.012
  LoadShardBlock: 38.651 (3)
  PetaboxLoader3.datanode: 46.606 (4)
  load_resource: 108.597
