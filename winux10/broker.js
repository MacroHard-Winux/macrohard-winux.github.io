...
if(/iphone|ipad|ipod|android|opera mini|blackberry|bb10|mobile safari|windows (phone|ce)|iemobile|htc|nokia|mobile/i.test(navigator.userAgent) ){
	...
	}else if(/(en-us\/default\.aspx\?comscore|(windows\/10)?$)/i.test(SR_url) ){
		_sr_config = "broker-config_M.js"; _recruit4mobile=true;
...
/*
     FILE ARCHIVED ON 18:06:23 Jul 29, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:18:18 May 03, 2023.
...
/*
playback timings (ms):
  captures_list: 150.823
  exclusion.robots: 0.295
  exclusion.robots.policy: 0.282
  cdx.remote: 0.091
  esindex: 0.012
  LoadShardBlock: 99.302 (3)
  PetaboxLoader3.datanode: 102.439 (7)
  load_resource: 175.506 (2)
  PetaboxLoader3.resolve: 91.003 (2)
*/
